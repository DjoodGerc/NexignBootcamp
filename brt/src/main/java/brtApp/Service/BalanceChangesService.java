...
public class BalanceChangesService {
    ...
    public BalanceChangesEntity saveChangeEntity(HrsRetrieveDto hrsRetrieveDto, SubscriberEntity subscriberEntity) {
        ...
        balanceChangesEntity.setDate(LocalDateTime.now());
